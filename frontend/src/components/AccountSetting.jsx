...
const AccountSetting = () => {
  ...
  const handleFormSubmit = (e) => {
    dispatch(reset());
    e.preventDefault();
    console.log(imgUrl, "imgUrlllllllllll");
    ...
    data.append("location",formData.address+","+formData.city);  // obaid change
...
//   // Function to get latitude and longitude from address and city using OpenCage Data API
//   const getLatLong = async (address, city) => {
...
//     const locationData = await getLatLong(formData.address, formData.city);
...
//     data.append("description", formData.description);
//     data.append("phone", formData.phone);
//     data.append("location", `${lat},${lng}`); // Store latitude and longitude
